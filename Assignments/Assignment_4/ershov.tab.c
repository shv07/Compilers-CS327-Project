...
/* In a future release of Bison, this section will be replaced
   by #include "ershov.tab.h".  */
#ifndef YY_YY_ERSHOV_TAB_H_INCLUDED
# define YY_YY_ERSHOV_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_ERSHOV_TAB_H_INCLUDED  */
...
{
      -1,    15,    22,   -11,    -1,    -2,   -11,   -11,   -11,   -11,
      -2,     3,   -11,    10,    -2,    -2,    -2,    -2,   -11,   -11,
       5,     5,   -11,   -11
};
...
{
      13,     8,     9,     1,    20,    21,    22,    23,    10,    14,
      15,    16,    17,    16,    17,    18,    14,    15,    16,    17,
       5,    19,     6,     7
};

static const yytype_uint8 yycheck[] =
{
      10,     3,     4,     4,    14,    15,    16,    17,    10,     6,
       7,     8,     9,     8,     9,    12,     6,     7,     8,     9,
       5,    11,     0,     4
};
...
{
       0,     4,    14,    15,    16,     5,     0,    15,     3,     4,
      10,    17,    18,    17,     6,     7,     8,     9,    12,    11,
      17,    17,    17,    17
};
...
#line 57 "ershov.y" /* yacc.c:1646  */
    {
							...
							(yyval.stmtnode)->down = (yyvsp[-1].node);
...
#line 69 "ershov.y" /* yacc.c:1646  */
    {(yyval.node)=(struct reg_node *) malloc(sizeof(struct reg_node));
						if((yyvsp[-2].node)->ersh==(yyvsp[0].node)->ersh)
							 ...
							 (yyval.node)->ersh = MAX((yyvsp[-2].node)->ersh,(yyvsp[0].node)->ersh);
						//printf("%d lineno: %d\n",$$->ersh, __LINE__);
...
#line 122 "ershov.y" /* yacc.c:1646  */
    {
				...
				//printf("%d lineno: %d\n",$$->ersh, __LINE__);
				(yyval.node)->name = strdup((yyvsp[0].tptr)->name);
				(yyval.node)->id_rec = (yyvsp[0].tptr);
				(yyval.node)->int_flag = 0;
